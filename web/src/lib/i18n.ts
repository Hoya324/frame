...
const ko: Dict = {
  ...
  "masters.nowTitle": "동시대의 거장들",
  "masters.nowHint": "작품은 저작권 보호 중 · 링크에서 감상하세요",
  "masters.nowVisit": "작품 보러 가기",
  ...
  "cinema.searchPlaceholder": "영화 · 감독 · 제작사",
  "cinema.sortNewest": "최신순",
  "cinema.sortOldest": "오래된순",
  "cinema.sortName": "이름순",
  "cinema.kindLabel": "구분",
  "cinema.kindModern": "현대 시네마",
  "cinema.kindPd": "퍼블릭 도메인",
  "cinema.decadeLabel": "연대",
  "cinema.count": "{n}편",
  "cinema.empty": "조건에 맞는 영화가 없어요",
  "curation.title": "큐레이션",
...
const en: Dict = {
  ...
  "masters.nowTitle": "Masters of Our Time",
  "masters.nowHint": "Works in copyright · view via the links",
  "masters.nowVisit": "View works",
  ...
  "cinema.searchPlaceholder": "Film · director · studio",
  "cinema.sortNewest": "Newest",
  "cinema.sortOldest": "Oldest",
  "cinema.sortName": "A–Z",
  "cinema.kindLabel": "Kind",
  "cinema.kindModern": "Modern",
  "cinema.kindPd": "Public domain",
  "cinema.decadeLabel": "Decade",
  "cinema.count": "{n} films",
  "cinema.empty": "No films match your filters",
...
const ja: Dict = {
  ...
  "masters.nowTitle": "同時代の巨匠たち",
  "masters.nowHint": "作品は著作権保護中 · リンクから鑑賞",
  "masters.nowVisit": "作品を見る",
  ...
  "cinema.searchPlaceholder": "映画 · 監督 · 制作",
  "cinema.sortNewest": "新しい順",
  "cinema.sortOldest": "古い順",
  "cinema.sortName": "名前順",
  "cinema.kindLabel": "区分",
  "cinema.kindModern": "現代シネマ",
  "cinema.kindPd": "パブリックドメイン",
  "cinema.decadeLabel": "年代",
  "cinema.count": "{n}本",
  "cinema.empty": "条件に合う映画がありません",
